...
export default function TextForm(props) {
    const {mode, title, showAlert} = props;
    ...
    return (
        <>
            <div className="container">
                <h2>{title}</h2>
                <div className="mb-3">
                    <textarea placeholder='Enter Your Text Here' style={{ backgroundColor: mode === 'light' ? 'white' : '#6a677a', color: mode === 'light' ? 'black' : 'white' }} className="form-control shadow" value={text} onChange={handleOnChange} id="myBox" rows="10"></textarea>
